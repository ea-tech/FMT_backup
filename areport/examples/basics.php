<?php
    ...
    $client_id = '1053774333778-lp402j33d81vrdoecshu9tecgoo94vff.apps.googleusercontent.com';
    
    // From the APIs console
    $client_secret = 'atK2mERZG_CcPryt37RhfMJL';
    
     // Url to your this page, must match the one in the APIs console
    $redirect_uri = 'http://www.findmetechie.com/analystic/update_pages.php';

    // Analytics account id like, 'ga:xxxxxxx'
    $account_id = 'ga:54388420';
