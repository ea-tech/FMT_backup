<?php
/**
 * Template Name: Edit Techie Profile
 */
             ...
             <div class="col-md-6 col-sm-6 col-xs-12">
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding"><span class="wpcf7-form-control-wrap project-detail">
                  <textarea name="project-detail" cols="40" rows="10" class="wpcf7-form-control wpcf7-textarea form-control heightAuto" aria-invalid="false" placeholder="MENTION NOT MORE THAN 5 MOST RECENT PROJECTS"><?php echo (get_the_author_meta('description', $profileid)); ?></textarea>
                  </span></div>
                <h4 class="font-s16">Educational Details</h4>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding"><span class="wpcf7-form-control-wrap educational">
                  <textarea name="educational" cols="40" rows="10" class="wpcf7-form-control wpcf7-textarea form-control heightAuto" aria-invalid="false" placeholder="e.g. BE/B Tech/ MCA OR ANY OTHER"><?php echo (get_the_author_meta('educational', $profileid)); ?></textarea>
                  </span></div>
                   <h4 class="font-s16">Preferences</h4>
                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding">
                  <span class="wpcf7-form-control-wrap strictly"><span class="wpcf7-form-control wpcf7-checkbox"><span class="wpcf7-list-item first"><label><input type="checkbox" name="strictly[]" value="Full Time" <?php if (in_array('Full Time', $preferences)) { echo "checked='checked'"; } ?>>
                  <span class="wpcf7-list-item-label">Full Time</span></label></span><span class="wpcf7-list-item"><label>
                  <input type="checkbox" name="strictly[]" value="Part Time" <?php if (in_array('Part Time', $preferences)) { echo "checked='checked'"; } ?>>
                  <span class="wpcf7-list-item-label">Part Time</span></label></span><span class="wpcf7-list-item last"><label>
                  <input type="checkbox" name="strictly[]" value="Project Based" <?php if (in_array('Project Based', $preferences)) { echo "checked='checked'"; } ?>>
                  <span class="wpcf7-list-item-label">Project Based</span></label></span></span></span>
                  </div>
                <!--<h4 cl ass="font-s16">Your Short/medium goal</h4>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding"><span class="wpcf7-form-control-wrap yourgoal">
                  <textarea name="yourgoal" cols="40" rows="10" class="wpcf7-form-control wpcf7-textarea form-control heightAuto" aria-invalid="false" placeholder="YOUR SHORT/MEDIUM GOAL DETAILS HERE"><?php echo (get_the_author_meta('yourgoal', $profileid)); ?></textarea>
                  </span></div>
                <h4 class="font-s16">Your Challenging Project</h4>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding"><span class="wpcf7-form-control-wrap challenging-project">
                  <textarea name="challenging-project" cols="40" rows="10" class="wpcf7-form-control wpcf7-textarea form-control heightAuto" aria-invalid="false" placeholder="YOUR CHALLENGING PROJECT DETAILS HERE"><?php echo (get_the_author_meta('challenging_project', $profileid)); ?></textarea>
                  </span></div> -->
                <p></p>
                 <br />
              </div>
