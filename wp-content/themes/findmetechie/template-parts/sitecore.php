...
.hire_perfect_ux {
    ...
    float: left;
    width: 100%;
    background-image: url(<?php echo get_stylesheet_directory_uri();?>/images/sitecore-tech-banner.jpg);
...
a.techieButton:hover, a.techieButton:focus {background:#0f4d76;color:#FFFFFF;}
@media (max-width: 991px) {
...
<div class="banner-ror">
  <div class="container">
    <div class="ror-banner-caption">
      ...
      <h1>Looking to hire certified <span>Microsoft Sitecore</span> developer?</h1>
        <ul>
...
<section id="scroll_down_ror" class="wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="200ms" >
  <div class="search-resumeRow1">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h3 class="techie-list remove-margin">Hire the best Microsoft Sitecore freelancers</h3>
          ...
          <div id="techie_container">
            <div class="serchtechie_width techie_width">
              <div class="tech-all-details"> <a  type="button" class="" data-toggle="modal" data-target=".bs-example-modal-sm" >
                <div class="featured_techei_img"> <img src="https://www.findmetechie.com/wp-content/uploads/thumbs/757/Picture032.jpg"> </div>
                <div class="featured_techei_title">
                  <p class="featured-title">Microsoft Sitecore Developer</p>
                  <span class="featured_techei_id"> <img src="https://www.findmetechie.com/wp-content/themes/findmetechie/images/flag/in.png" alt="" title="India" /> FMT ID: 757 </span> <span class="featured_techei_exp"> 5 Years </span> </div>
                <div class="featured_techei_added"> <span class="featured_techei_added_tech">Microsoft Sitecore</span> </div>
                </a>
                <div class="techie_join_section">
                  <div class="techie_butns"> <a <?php if((in_array('employer', $user->roles)) || (in_array('administrator', $user->roles)) ){ ?> href="<?php echo site_url()."/profile/757";?>" <?php } else { ?> type="button" data-toggle="modal" data-target=".bs-example-modal-sm" <?php } ?> class="build-your-team">View my profile</a> <a onclick="hire_me(757)" type="button" data-toggle="modal" data-target=".bs-example-modal-sm" class="build-your-team">Hire me</a> </div>
                </div>
              </div>
            </div>
            <div class="serchtechie_width techie_width">
              <div class="tech-all-details"> <a  type="button" class="" data-toggle="modal" data-target=".bs-example-modal-sm" >
                <div class="featured_techei_img"> <img src="https://www.findmetechie.com/wp-content/uploads/thumbs/2010/balasubbarao.PNG"> </div>
                <div class="featured_techei_title">
                  <p class="featured-title">Technical Lead</p>
                  <span class="featured_techei_id"> <img src="https://www.findmetechie.com/wp-content/themes/findmetechie/images/flag/in.png" alt="" title="Pakistan" /> FMT ID: 2010 </span> <span class="featured_techei_exp"> 7 Years </span> </div>
                <div class="featured_techei_added"> <span class="featured_techei_added_tech">Sitecore</span> </div>
                </a>
                <div class="techie_join_section">
                  <div class="techie_butns"> <a <?php if((in_array('employer', $user->roles)) || (in_array('administrator', $user->roles)) ){ ?> href="<?php echo site_url()."/profile/2010";?>" <?php } else { ?> type="button" data-toggle="modal" data-target=".bs-example-modal-sm" <?php } ?> class="build-your-team">View my profile</a> <a onclick="hire_me(2010)" type="button" data-toggle="modal" data-target=".bs-example-modal-sm" class="build-your-team">Hire me</a> </div>
                </div>
              </div>
            </div>
            <div class="serchtechie_width techie_width">
              <div class="tech-all-details"> <a  type="button" class="" data-toggle="modal" data-target=".bs-example-modal-sm" >
                <div class="featured_techei_img"> <img src="https://www.findmetechie.com/wp-content/uploads/thumbs/2011/AAEAAQAAAAAAAAvHAAAAJGZmOGQxZDJiLWIxZjctNDdiMi1hNDRlLTQxODI4ZTQyMDJkYw.jpg" alt="techie"/> </div>
                <div class="featured_techei_title">
                  <p class="featured-title">Sitecore Developer</p>
                  <span class="featured_techei_id"> <img src="https://www.findmetechie.com/wp-content/themes/findmetechie/images/flag/in.png" alt="" title="India" /> FMT ID: 2011 </span> <span class="featured_techei_exp"> 3 Years </span> </div>
                <div class="featured_techei_added"> <span class="featured_techei_added_tech">Sitecore</span> </div>
                </a>
                <div class="techie_join_section">
                  <div class="techie_butns"> <a <?php if((in_array('employer', $user->roles)) || (in_array('administrator', $user->roles)) ){ ?> href="<?php echo site_url()."/profile/2011";?>" <?php } else { ?> type="button" data-toggle="modal" data-target=".bs-example-modal-sm" <?php } ?> class="build-your-team">View my profile</a> <a onclick="hire_me(2011)" type="button" data-toggle="modal" data-target=".bs-example-modal-sm" class="build-your-team">Hire me</a> </div>
                </div>
              </div>
            </div>
            <div class="serchtechie_width techie_width">
              <div class="tech-all-details"> <a  type="button" class="" data-toggle="modal" data-target=".bs-example-modal-sm" >
                <div class="featured_techei_img"> <img src="https://www.findmetechie.com/wp-content/uploads/thumbs/2014/Me for profile pic.jpg" alt="techie"/> </div>
                <div class="featured_techei_title">
                  <p class="featured-title">Sr. Sitecore Developer</p>
                  <span class="featured_techei_id"> <img src="https://www.findmetechie.com/wp-content/themes/findmetechie/images/flag/us.png" alt="" title="India" /> FMT ID: 2014 </span> <span class="featured_techei_exp"> 7 Years </span> </div>
                <div class="featured_techei_added"> <span class="featured_techei_added_tech">Sitecore</span> </div>
                </a>
                <div class="techie_join_section">
                  <div class="techie_butns"> <a <?php if((in_array('employer', $user->roles)) || (in_array('administrator', $user->roles)) ){ ?> href="<?php echo site_url()."/profile/2014";?>" <?php } else { ?> type="button" data-toggle="modal" data-target=".bs-example-modal-sm" <?php } ?> class="build-your-team">View my profile</a> <a onclick="hire_me(2014)" type="button" data-toggle="modal" data-target=".bs-example-modal-sm" class="build-your-team">Hire me</a> </div>
                </div>
              </div>
            </div>
            <div class="serchtechie_width techie_width">
              <div class="tech-all-details"> <a  type="button" class="" data-toggle="modal" data-target=".bs-example-modal-sm" >
                <div class="featured_techei_img"> <img src="https://www.findmetechie.com/wp-content/uploads/thumbs/2031/KetanGarala.jpg"> </div>
                <div class="featured_techei_title">
                  <p class="featured-title">Certified Sitecore Developer</p>
                  <span class="featured_techei_id"> <img src="https://www.findmetechie.com/wp-content/themes/findmetechie/images/flag/in.png" alt="" title="India" /> FMT ID: 2031 </span> <span class="featured_techei_exp"> 10 Years </span> </div>
                <div class="featured_techei_added"> <span class="featured_techei_added_tech">sitecore</span> </div>
                </a>
                <div class="techie_join_section">
                  <div class="techie_butns"> <a <?php if((in_array('employer', $user->roles)) || (in_array('administrator', $user->roles)) ){ ?> href="<?php echo site_url()."/profile/2031";?>" <?php } else { ?> type="button" data-toggle="modal" data-target=".bs-example-modal-sm" <?php } ?> class="build-your-team">View my profile</a> <a onclick="hire_me(2031)" type="button" data-toggle="modal" data-target=".bs-example-modal-sm" class="build-your-team">Hire me</a> </div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="main-block">
        <div class="col-md-3 col-sm-6 col-xs-12 section_backcolor_ror">
          <div class="block_ror">
            ...
            <h3>Our Microsoft Sitecore Services</h3>
            <ul>
              <li>Sitecore Consultation</li>
              <li>Sitecore Template Customization</li>
              <li>Sitecore Module Development</li>
              <li>Sitecore E-commerce Implementations</li>
              <li>Sitecore Third Party Integration e.g. CRM,ERP</li>
              <li>Sitecore Custom Development & Deployments</li>
              <li>Multi-language Site Globalization</li>
              <li>Internet, Intranet, Portal & Extranet Development</li>
            </ul>
          </div>
        </div>
        <div class="col-md-3 col-sm-6 col-xs-12 section_backcolor_ror">
  ...
  <div class="container">
    <div class="do_more">
      <div class="domore_content">
        ...
        <p> Certified Sitecore Developers</p>
