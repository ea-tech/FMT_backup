...
?>/images/javaServices.jpg) no-repeat center right;
	background-size: cover;
}
.bg_red p {
	color: #fff;
...
<div class="banner-ror">
  <div class="container">
    <div class="ror-banner-caption">
      ...
      <h1>Looking to hire <span>Java/J2EE</span> developer?</h1>
        <ul>
...
<div class="search-resumeRow1">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <h3 class="techie-list remove-margin">Hire the best Java freelancers</h3>
        ...
        <div id="techie_container">
          <div class="serchtechie_width techie_width">
            <div class="tech-all-details"> <a  type="button" class="" data-toggle="modal" data-target=".bs-example-modal-sm" >
              <div class="featured_techei_img"> <img src="https://www.findmetechie.com/wp-content/uploads/thumbs/294/1417010630.jpg"> </div>
              <div class="featured_techei_title">
                <p class="featured-title">Sr. Developer</p>
                <span class="featured_techei_id"> <img src="https://www.findmetechie.com/wp-content/themes/findmetechie/images/flag/ar.png" alt="" title="India" /> FMT ID: 294 </span> <span class="featured_techei_exp"> 10+ Years </span> </div>
              <div class="featured_techei_added"> <span class="featured_techei_added_tech">Java</span> </div>
              </a>
              <div class="techie_join_section">
                <div class="techie_butns"> <a <?php if((in_array('employer', $user->roles)) || (in_array('administrator', $user->roles)) ){ ?> href="<?php echo site_url()."/profile/294";?>" <?php } else { ?> type="button" data-toggle="modal" data-target=".bs-example-modal-sm" <?php } ?> class="build-your-team">View my profile</a> <a onclick="hire_me(294)" type="button" data-toggle="modal" data-target=".bs-example-modal-sm" class="build-your-team">Hire me</a> </div>
              </div>
            </div>
          </div>
          <div class="serchtechie_width techie_width">
            <div class="tech-all-details"> <a  type="button" class="" data-toggle="modal" data-target=".bs-example-modal-sm" >
              <div class="featured_techei_img"> <img src="https://www.findmetechie.com/wp-content/uploads/thumbs/352/1450699042.jpg"> </div>
              <div class="featured_techei_title">
                <p class="featured-title">Software Engineer</p>
                <span class="featured_techei_id"> <img src="https://www.findmetechie.com/wp-content/themes/findmetechie/images/flag/eg.png" alt="" title="Pakistan" /> FMT ID: 352 </span> <span class="featured_techei_exp"> 4 Years </span> </div>
              <div class="featured_techei_added"> <span class="featured_techei_added_tech">Java</span> </div>
              </a>
              <div class="techie_join_section">
                <div class="techie_butns"> <a <?php if((in_array('employer', $user->roles)) || (in_array('administrator', $user->roles)) ){ ?> href="<?php echo site_url()."/profile/352";?>" <?php } else { ?> type="button" data-toggle="modal" data-target=".bs-example-modal-sm" <?php } ?> class="build-your-team">View my profile</a> <a onclick="hire_me(352)" type="button" data-toggle="modal" data-target=".bs-example-modal-sm" class="build-your-team">Hire me</a> </div>
              </div>
            </div>
          </div>
          <div class="serchtechie_width techie_width">
            <div class="tech-all-details"> <a  type="button" class="" data-toggle="modal" data-target=".bs-example-modal-sm" >
              <div class="featured_techei_img"> <img src="https://www.findmetechie.com/wp-content/uploads/thumbs/1725/20228915_1624290894289598_767816133210940923_n.jpg" alt="techie"/> </div>
              <div class="featured_techei_title">
                <p class="featured-title">Sr. Full Stack Developer</p>
                <span class="featured_techei_id"> <img src="https://www.findmetechie.com/wp-content/themes/findmetechie/images/flag/in.png" alt="" title="India" /> FMT ID: 1725 </span> <span class="featured_techei_exp"> 6 Years </span> </div>
              <div class="featured_techei_added"> <span class="featured_techei_added_tech">Java</span> </div>
              </a>
              <div class="techie_join_section">
                <div class="techie_butns"> <a <?php if((in_array('employer', $user->roles)) || (in_array('administrator', $user->roles)) ){ ?> href="<?php echo site_url()."/profile/1725";?>" <?php } else { ?> type="button" data-toggle="modal" data-target=".bs-example-modal-sm" <?php } ?> class="build-your-team">View my profile</a> <a onclick="hire_me(1725)" type="button" data-toggle="modal" data-target=".bs-example-modal-sm" class="build-your-team">Hire me</a> </div>
              </div>
            </div>
          </div>
          <div class="serchtechie_width techie_width">
            <div class="tech-all-details"> <a  type="button" class="" data-toggle="modal" data-target=".bs-example-modal-sm" >
              <div class="featured_techei_img"> <img src="https://www.findmetechie.com/wp-content/uploads/thumbs/1817/DSC_0109p.jpg" alt="techie"/> </div>
              <div class="featured_techei_title">
                <p class="featured-title">Java Developer</p>
                <span class="featured_techei_id"> <img src="https://www.findmetechie.com/wp-content/themes/findmetechie/images/flag/in.png" alt="" title="India" /> FMT ID: 1817 </span> <span class="featured_techei_exp"> 7 Years </span> </div>
              <div class="featured_techei_added"> <span class="featured_techei_added_tech">Java</span> </div>
              </a>
              <div class="techie_join_section">
                <div class="techie_butns"> <a <?php if((in_array('employer', $user->roles)) || (in_array('administrator', $user->roles)) ){ ?> href="<?php echo site_url()."/profile/1817";?>" <?php } else { ?> type="button" data-toggle="modal" data-target=".bs-example-modal-sm" <?php } ?> class="build-your-team">View my profile</a> <a onclick="hire_me(1817)" type="button" data-toggle="modal" data-target=".bs-example-modal-sm" class="build-your-team">Hire me</a> </div>
              </div>
            </div>
          </div>
          <div class="serchtechie_width techie_width">
            <div class="tech-all-details"> <a  type="button" class="" data-toggle="modal" data-target=".bs-example-modal-sm" >
              <div class="featured_techei_img"> <img src="https://www.findmetechie.com/wp-content/uploads/thumbs/1844/sun.png"> </div>
              <div class="featured_techei_title">
                <p class="featured-title">Java Developer</p>
                <span class="featured_techei_id"> <img src="https://www.findmetechie.com/wp-content/themes/findmetechie/images/flag/in.png" alt="" title="India" /> FMT ID: 1844 </span> <span class="featured_techei_exp"> 2 Years </span> </div>
              <div class="featured_techei_added"> <span class="featured_techei_added_tech">Java</span> </div>
              </a>
              <div class="techie_join_section">
                <div class="techie_butns"> <a <?php if((in_array('employer', $user->roles)) || (in_array('administrator', $user->roles)) ){ ?> href="<?php echo site_url()."/profile/1844";?>" <?php } else { ?> type="button" data-toggle="modal" data-target=".bs-example-modal-sm" <?php } ?> class="build-your-team">View my profile</a> <a onclick="hire_me(1844)" type="button" data-toggle="modal" data-target=".bs-example-modal-sm" class="build-your-team">Hire me</a> </div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="main-block">
        <div class="col-md-3 col-sm-6 col-xs-12 section_backcolor_ror">
          <div class="block_ror">
            ...
            <h3>Our Java Development Services</h3>
            <ul>
              <li>Java/J2EE application development</li>
              <li>Product Development</li>
              <li>Java web API development</li>
              <li>Enterprise Java development</li>
              <li>Java mobile application development</li>
              <li>Java Swings app development</li>
              <li>Struts Development</li>
              <li>Modernization from Legacy Application to Java/J2EE</li>
              <li>Revamp of Java/J2EE Applications</li>
            </ul>
          </div>
        </div>
        <div class="col-md-3 col-sm-6 col-xs-12 section_backcolor_ror">
  ...
  <div class="hire_perfect">
    <div class="do_more wow fadeInDown " data-wow-duration="1000ms" data-wow-delay="200ms">
      <div class="domore_content">
        ...
        <p>Enterprise level solutions using MVC, MVVM and Micro services architecture.</p>
        <p>Agile project management with skilled professionals.</p>
        <p>We develop reliable and secure Java applications.</p>
        <p>Java maintenance, support and data migration services to cater the clients.</p>
        <p>Agile methodology with quality, scalability and time tested approaches.</p>
      </div>
    </div>
