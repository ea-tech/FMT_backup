...
.bg_red {
 background: url(<?php echo get_stylesheet_directory_uri();?>/images/blockchain-banner.jpg) no-repeat center right;
	background-size: cover;
}
.bg_red p {
	color: #fff;
...
<div class="banner-ror">
  <div class="container">
    <div class="ror-banner-caption">
      ...
      <h1>Looking to hire <span>Blockchain</span> developer?</h1>
        <ul>
...
<section id="scroll_down_ror" class="wow fadeInDown bg_ror_gray" data-wow-duration="1000ms" data-wow-delay="200ms" >
      ...
      <div class="main-block">
        <div class="col-md-3 col-sm-6 col-xs-12 section_backcolor_ror">
          <div class="block_ror">
            ...
            <h3>Blockchain Service Offerings</h3>
            <ul>
                <li> Blockchain technical Consulting</li> 
                <li>Blockchain Application Development </li>
                <li>Smart Contract Development</li>
                <li>Smart Contract Audit</li>
                <li>Crypto-currency Development</li>
                <li>Supply Chain Blockchain Development</li>
...
<!--<section class="wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="200ms" >
  <div class="search-resumeRow1">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h3 class="techie-list remove-margin">Hire the best Ruby on Rails freelancers</h3>
          ...
          <div id="techie_container">
            <div class="serchtechie_width techie_width">
              <div class="tech-all-details"> <a  type="button" class="" data-toggle="modal" data-target=".bs-example-modal-sm" >
                <div class="featured_techei_img"> <img src="http://www.findmetechie.com/wp-content/themes/findmetechie/images/techiear.jpeg"> </div>
                <div class="featured_techei_title">
                  <p class="featured-title">Sr. Rails Developer</p>
                  <span class="featured_techei_id"> <img src="http://www.findmetechie.com/wp-content/themes/findmetechie/images/flag/ar.png" alt="" title="India" /> FMT ID: 233 </span> <span class="featured_techei_exp"> 10+ Years </span> </div>
                <div class="featured_techei_added"> <span class="featured_techei_added_tech">Ruby on Rails</span> </div>
                </a>
                <div class="techie_join_section">
                  <div class="techie_butns"> <a href="https://www.findmetechie.com/profile/233" type="button" data-toggle="modal" data-target=".bs-example-modal-sm" class="build-your-team">View my profile</a> <a onclick="hire_me(233)" type="button" data-toggle="modal" data-target=".bs-example-modal-sm" class="build-your-team">Hire me</a> </div>
                </div>
              </div>
            </div>
            <div class="serchtechie_width techie_width">
              <div class="tech-all-details"> <a  type="button" class="" data-toggle="modal" data-target=".bs-example-modal-sm" >
                <div class="featured_techei_img"> <img src="http://www.findmetechie.com/wp-content/themes/findmetechie/images/techie731.png"> </div>
                <div class="featured_techei_title">
                  <p class="featured-title">Sr. Ruby Developer</p>
                  <span class="featured_techei_id"> <img src="http://www.findmetechie.com/wp-content/themes/findmetechie/images/flag/lv.png" alt="" title="Pakistan" /> FMT ID: 731 </span> <span class="featured_techei_exp"> 6 Years </span> </div>
                <div class="featured_techei_added"> <span class="featured_techei_added_tech">Ruby on Rails</span> </div>
                </a>
                <div class="techie_join_section">
                  <div class="techie_butns"> <a href="https://www.findmetechie.com/profile/731" type="button" data-toggle="modal" data-target=".bs-example-modal-sm" class="build-your-team">View my profile</a> <a onclick="hire_me(731)" type="button" data-toggle="modal" data-target=".bs-example-modal-sm" class="build-your-team">Hire me</a> </div>
                </div>
              </div>
            </div>
            <div class="serchtechie_width techie_width">
              <div class="tech-all-details"> <a  type="button" class="" data-toggle="modal" data-target=".bs-example-modal-sm" >
                <div class="featured_techei_img"> <img src="http://www.findmetechie.com/wp-content/themes/findmetechie/images/techie803.jpg" alt="techie"/> </div>
                <div class="featured_techei_title">
                  <p class="featured-title">Sr. RoR Developer</p>
                  <span class="featured_techei_id"> <img src="http://www.findmetechie.com/wp-content/themes/findmetechie/images/flag/in.png" alt="" title="India" /> FMT ID: 803 </span> <span class="featured_techei_exp"> 4 Years </span> </div>
                <div class="featured_techei_added"> <span class="featured_techei_added_tech">Ruby on Rails</span> </div>
                </a>
                <div class="techie_join_section">
                  <div class="techie_butns"> <a href="https://www.findmetechie.com/profile/803" type="button" data-toggle="modal" data-target=".bs-example-modal-sm" class="build-your-team">View my profile</a> <a onclick="hire_me(803)" type="button" data-toggle="modal" data-target=".bs-example-modal-sm" class="build-your-team">Hire me</a> </div>
                </div>
              </div>
            </div>
            <div class="serchtechie_width techie_width">
              <div class="tech-all-details"> <a  type="button" class="" data-toggle="modal" data-target=".bs-example-modal-sm" >
                <div class="featured_techei_img"> <img src="http://www.findmetechie.com/wp-content/themes/findmetechie/images/techie1687.jpg" alt="techie"/> </div>
                <div class="featured_techei_title">
                  <p class="featured-title">Ruby on Rails Developer</p>
                  <span class="featured_techei_id"> <img src="http://www.findmetechie.com/wp-content/themes/findmetechie/images/flag/br.png" alt="" title="India" /> FMT ID: 1687 </span> <span class="featured_techei_exp"> 9 Years </span> </div>
                <div class="featured_techei_added"> <span class="featured_techei_added_tech">Ruby on Rails</span> </div>
                </a>
                <div class="techie_join_section">
                  <div class="techie_butns"> <a href="https://www.findmetechie.com/profile/1687" type="button" data-toggle="modal" data-target=".bs-example-modal-sm" class="build-your-team">View my profile</a> <a onclick="hire_me(1687)" type="button" data-toggle="modal" data-target=".bs-example-modal-sm" class="build-your-team">Hire me</a> </div>
                </div>
              </div>
            </div>
            <div class="serchtechie_width techie_width">
              <div class="tech-all-details"> <a  type="button" class="" data-toggle="modal" data-target=".bs-example-modal-sm" >
                <div class="featured_techei_img"> <img src="http://www.findmetechie.com/wp-content/themes/findmetechie/images/techie1712.jpg"> </div>
                <div class="featured_techei_title">
                  <p class="featured-title">Sr. Ruby Developer</p>
                  <span class="featured_techei_id"> <img src="http://www.findmetechie.com/wp-content/themes/findmetechie/images/flag/ar.png" alt="" title="India" /> FMT ID: 1712 </span> <span class="featured_techei_exp"> 9 Years </span> </div>
                <div class="featured_techei_added"> <span class="featured_techei_added_tech">Ruby on Rails</span> </div>
                </a>
                <div class="techie_join_section">
                  <div class="techie_butns"> <a href="https://www.findmetechie.com/profile/1712" type="button" data-toggle="modal" data-target=".bs-example-modal-sm" class="build-your-team">View my profile</a> <a onclick="hire_me(1712)" type="button" data-toggle="modal" data-target=".bs-example-modal-sm" class="build-your-team">Hire me</a> </div>
                </div>
              </div>
            </div>
          </div>
          <div class="cl"></div>
          <div class="mgt-30"> <a href="javascript:void(0);" class="build-your-team restrict_employer_button" data-toggle="modal" data-target="#myModal0">Hire a Techie</a> <a href="http://www.findmetechie.com/build-developement-team/" class="build-your-team">Build your team</a></div>
          <div class="cl"></div>
        </div>
      </div>
    </div>
...
<div class="featured_technology">
  <div class="container">
    ...
    <div class="resume-container">
      <div class="row">
        <div class="col-md-2 col-sm-2 col-xs-6 resume-box">
          <div class="profileImage"> <a href="https://www.findmetechie.com/technology/php/"> <img src="https://www.findmetechie.com/wp-content/uploads/2013/09/12.png">
            <p class="title_service"> PHP </p>
            </a> </div>
        </div>
        <div class="col-md-2 col-sm-2 col-xs-6 resume-box">
          <div class="profileImage"> <a href="https://www.findmetechie.com/technology/asp-net/"> <img src="https://www.findmetechie.com/wp-content/uploads/2013/09/15.png">
            <p class="title_service"> DotNet </p>
            </a> </div>
        </div>
        <div class="col-md-2 col-sm-2 col-xs-6 resume-box">
          <div class="profileImage"> <a href="https://www.findmetechie.com/technology/java-j2ee/"> <img src="https://www.findmetechie.com/wp-content/uploads/2013/09/16.png">
            <p class="title_service"> Java </p>
            </a> </div>
        </div>
        <div class="col-md-2 col-sm-2 col-xs-6 resume-box">
          <div class="profileImage"> <a href="https://www.findmetechie.com/technology/joomla/"> <img src="https://www.findmetechie.com/wp-content/uploads/2017/05/joomla2.png">
            <p class="title_service"> Joomla </p>
            </a> </div>
        </div>
        <div class="col-md-2 col-sm-2 col-xs-6 resume-box">
          <div class="profileImage"> <a href="https://www.findmetechie.com/technology/drupal/"> <img src="https://www.findmetechie.com/wp-content/uploads/2017/05/drupal-1.png">
            <p class="title_service"> Drupal </p>
            </a> </div>
        </div>
        <div class="col-md-2 col-sm-2 col-xs-6 resume-box">
          <div class="profileImage"> <a href="https://www.findmetechie.com/technology/magento/"> <img src="https://www.findmetechie.com/wp-content/uploads/2017/05/Magento2.png">
            <p class="title_service"> Magento </p>
            </a> </div>
        </div>
      </div>
    </div>
  ...
  <div class="hire_perfect">
    <div class="do_more wow fadeInDown " data-wow-duration="1000ms" data-wow-delay="200ms">
      <div class="domore_content">
        ...
        <p>Comprehensive knowledge on blockchain technology</p>
        <p>Specialized in Proof of Concept (POC) development</p>
        <p>Expertise in catering different countries with varied time zones.</p>
        <p>Rapid application development (RAD) within budget.</p>
        <p>Responsible approach to the client's requirement.</p>
