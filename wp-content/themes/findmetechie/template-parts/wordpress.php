...
<link rel="stylesheet" href="https://www.findmetechie.com/wp-content/themes/findmetechie/css/template.css">


<section>
    <div class="banner-drupal wordpress">
      <div class="container">
        <div class="row">
          <div class=" col-md-offset-4  col-md-4 col-sm-7 col-xs-12">
            <div class="drupal">
              <h1>WordPress
              <span> CMS development services</span></h1>
              <h2>We create cutting edge websites with unique <span>WordPress</span> solutions.</h2>
...
<section class="wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="200ms">
  <div class="container">
    <div class="background_proces-first wordpress">
      <div class="row-1"> 
        <div class="col-md-4 col-sm-12 col-xs-12  dru-pad-10">
          <div class="psd_drupal">
            <h2>Open Source CMS Development</h2>
            <p>We offer high performance, secure and scalable CMS web solution with WordPress as a simple business process that saving your both time and cost.</p>
          </div>
        </div>
        <div class="col-md-8 col-sm-12 col-xs-12 dru-pad-10">
          <div class="row-1">
             <div class="col-md-12 col-sm-12 col-xs-12 dru-pad-10">
               <div class="shopping-cart">
                <h2>WordPress e-commerce Solution</h2>
                 <p>End-to-end ecommerce solutions with WordPress websites for an online store, B2B or B2C shopping experience, we have got you covered.</p>
               </div>
             </div>
             <div class="col-md-6 col-sm-12 col-xs-12 dru-pad-10">
               <div class="theme-development">
                <h2>Custom Plug-In Development</h2>
                 <p>With plugin customization, feature-rich plug-ins creation and integration to make your business website stands up with next generation business completion.</p>
               </div>
             </div>
             <div class="col-md-6 col-sm-12 col-xs-12 dru-pad-10">
               <div class="cms-development">
                <h2>WordPress Theme & Template</h2>
                 <p>Adorn your website with unique and attractive theme development service that our talented designers come up with.</p>
               </div>
             </div>
          </div>
        </div>
        ...
        <div class="col-md-4 col-sm-6 col-sm-12 dru-pad-10">
         ...
         <div class="col-md-4 col-sm-6 col-sm-12 dru-pad-10">
          <div class="drup-step-block">
            ...
            <p>We integrate design as per approved from client (PSD or final design) on wordpress.</p>
          </div>
        </div>
         <div class="col-md-4 col-sm-6 col-sm-12 dru-pad-10">
          <div class="drup-step-block">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          ...
          <h2>Hire the best WordPress freelancers</h2>
          </div>
        </div>
      </div>
    </div>
          ...
          <div id="techie_container">
            <div class="serchtechie_width techie_width">
              <div class="tech-all-details"> <a type="button" class="" data-toggle="modal" data-target=".bs-example-modal-sm">
                <div class="featured_techei_img"> <img src="https://www.findmetechie.com/wp-content/uploads/thumbs/1826/2017-headshot.jpg"> </div>
                <div class="featured_techei_title">
                  <p class="featured-title">WordPress Theme Designer/Dev.</p>
                  <span class="featured_techei_id"> <img src="https://www.findmetechie.com/wp-content/themes/findmetechie/images/flag/us.png" alt="" title="India"> FMT ID: 1826 </span> <span class="featured_techei_exp"> 10+ Years </span> </div>
                <div class="featured_techei_added"> <span class="featured_techei_added_tech">WordPress</span> </div>
                </a>
                <div class="techie_join_section">
                  <div class="techie_butns"> <a <?php if((in_array('employer', $user->roles)) || (in_array('administrator', $user->roles)) ){ ?> href="<?php echo site_url()."/profile/1826";?>" <?php } else { ?> type="button" data-toggle="modal" data-target=".bs-example-modal-sm" <?php } ?> class="build-your-team">View my profile</a> <a onclick="hire_me(1826)" type="button" data-toggle="modal" data-target=".bs-example-modal-sm" class="build-your-team">Hire me</a> </div>
                </div>
              </div>
            </div>
            <div class="serchtechie_width techie_width">
              <div class="tech-all-details"> <a type="button" class="" data-toggle="modal" data-target=".bs-example-modal-sm">
                <div class="featured_techei_img"> <img src="https://www.findmetechie.com/wp-content/uploads/thumbs/1834/16359177_266181403813032_1090366078_n.jpg"> </div>
                <div class="featured_techei_title">
                  <p class="featured-title">WordPress/Shopify Developer</p>
                  <span class="featured_techei_id"> <img src="https://www.findmetechie.com/wp-content/themes/findmetechie/images/flag/in.png" alt="" title="Pakistan"> FMT ID: 1834 </span> <span class="featured_techei_exp"> 3 Years </span> </div>
                <div class="featured_techei_added"> <span class="featured_techei_added_tech">WordPress</span> </div>
                </a>
                <div class="techie_join_section">
                  <div class="techie_butns"> <a <?php if((in_array('employer', $user->roles)) || (in_array('administrator', $user->roles)) ){ ?> href="<?php echo site_url()."/profile/1834";?>" <?php } else { ?> type="button" data-toggle="modal" data-target=".bs-example-modal-sm" <?php } ?> class="build-your-team">View my profile</a> <a onclick="hire_me(1834)" type="button" data-toggle="modal" data-target=".bs-example-modal-sm" class="build-your-team">Hire me</a> </div>
                </div>
              </div>
            </div>
            <div class="serchtechie_width techie_width">
              <div class="tech-all-details"> <a type="button" class="" data-toggle="modal" data-target=".bs-example-modal-sm">
                <div class="featured_techei_img"> <img src="https://www.findmetechie.com/wp-content/uploads/thumbs/962/10265416_10152010597561899_4991312853781868002_o.jpg" alt="techie"> </div>
                <div class="featured_techei_title">
                  <p class="featured-title">WordPress Developer</p>
                  <span class="featured_techei_id"> <img src="https://www.findmetechie.com/wp-content/themes/findmetechie/images/flag/in.png" alt="" title="India"> FMT ID: 962 </span> <span class="featured_techei_exp"> 4 Years </span> </div>
                <div class="featured_techei_added"> <span class="featured_techei_added_tech">WordPress</span> </div>
                </a>
                <div class="techie_join_section">
                  <div class="techie_butns"> <a <?php if((in_array('employer', $user->roles)) || (in_array('administrator', $user->roles)) ){ ?> href="<?php echo site_url()."/profile/962";?>" <?php } else { ?> type="button" data-toggle="modal" data-target=".bs-example-modal-sm" <?php } ?> class="build-your-team">View my profile</a> <a onclick="hire_me(962)" type="button" data-toggle="modal" data-target=".bs-example-modal-sm" class="build-your-team">Hire me</a> </div>
                </div>
              </div>
            </div>
            <div class="serchtechie_width techie_width">
              <div class="tech-all-details"> <a type="button" class="" data-toggle="modal" data-target=".bs-example-modal-sm">
                <div class="featured_techei_img"> <img src="https://www.findmetechie.com/wp-content/uploads/thumbs/1742/IMG-20170819-WA0000.png" alt="techie"> </div>
                <div class="featured_techei_title">
                  <p class="featured-title">Sr. Web Developer</p>
                  <span class="featured_techei_id"> <img src="https://www.findmetechie.com/wp-content/themes/findmetechie/images/flag/in.png" alt="" title="India"> FMT ID: 1742</span> <span class="featured_techei_exp"> 7 Years </span> </div>
                <div class="featured_techei_added"> <span class="featured_techei_added_tech">WordPress</span> </div>
                </a>
                <div class="techie_join_section">
                  <div class="techie_butns"> <a <?php if((in_array('employer', $user->roles)) || (in_array('administrator', $user->roles)) ){ ?> href="<?php echo site_url()."/profile/1742";?>" <?php } else { ?> type="button" data-toggle="modal" data-target=".bs-example-modal-sm" <?php } ?> class="build-your-team">View my profile</a> <a onclick="hire_me(1742)" type="button" data-toggle="modal" data-target=".bs-example-modal-sm" class="build-your-team">Hire me</a> </div>
                </div>
              </div>
            </div>
            <div class="serchtechie_width techie_width">
              <div class="tech-all-details"> <a type="button" class="" data-toggle="modal" data-target=".bs-example-modal-sm">
                <div class="featured_techei_img"> <img src="https://www.findmetechie.com/wp-content/uploads/thumbs/926/15697554_1147743788679078_8114818241253907842_n.jpg"> </div>
                <div class="featured_techei_title">
                  <p class="featured-title">WordPress Developer</p>
                  <span class="featured_techei_id"> <img src="https://www.findmetechie.com/wp-content/themes/findmetechie/images/flag/in.png" alt="" title="India"> FMT ID: 926 </span> <span class="featured_techei_exp"> 2 Years </span> </div>
                <div class="featured_techei_added"> <span class="featured_techei_added_tech">WordPress</span> </div>
                </a>
                <div class="techie_join_section">
                  <div class="techie_butns"> <a <?php if((in_array('employer', $user->roles)) || (in_array('administrator', $user->roles)) ){ ?> href="<?php echo site_url()."/profile/926";?>" <?php } else { ?> type="button" data-toggle="modal" data-target=".bs-example-modal-sm" <?php } ?> class="build-your-team">View my profile</a> <a onclick="hire_me(926)" type="button" data-toggle="modal" data-target=".bs-example-modal-sm" class="build-your-team">Hire me</a> </div>
                </div>
              </div>
            </div>
          </div>
...
<section class="wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="200ms">
  <div class="get_touch">
    ...
    <div class="container"> 
      <h2>Why WordPress development from FindMeTechie?</h2>
...
<div class="clearfix"></div>
<section  class="wow fadeInDown " data-wow-duration="1000ms" data-wow-delay="200ms">
  <div class="hire_perfect_ux wordpress">
  <div class="container">
    <div class="do_more">
...
</div><button style="display:none" id="very_unique" type="hidden" data-toggle="modal" data-target="#useremployer_restrict"></button>
