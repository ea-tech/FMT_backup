...
?>/images/dotNetServices.jpg) no-repeat center right;
	background-size: cover;
}
.bg_red p {
	color: #fff;
...
<div class="banner-ror">
  <div class="container">
    <div class="ror-banner-caption">
      ...
      <h1>Looking to hire <span>DotNet</span> developer?</h1>
        <ul>
...
<div class="search-resumeRow1">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <h3 class="techie-list remove-margin">Hire the best DotNet freelancers</h3>
        ...
        <div id="techie_container">
          <div class="serchtechie_width techie_width">
            <div class="tech-all-details"> <a  type="button" class="" data-toggle="modal" data-target=".bs-example-modal-sm" >
              <div class="featured_techei_img"> <img src="https://www.findmetechie.com/wp-content/uploads/thumbs/973/13043573_10153546051661911_6655791000390736590_n.jpg"> </div>
              <div class="featured_techei_title">
                <p class="featured-title">Dotnet Developer</p>
                <span class="featured_techei_id"> <img src="https://www.findmetechie.com/wp-content/themes/findmetechie/images/flag/jo.png" alt="" title="India" /> FMT ID: 973 </span> <span class="featured_techei_exp"> 2 Years </span> </div>
              <div class="featured_techei_added"> <span class="featured_techei_added_tech">Dotnet</span> </div>
              </a>
              <div class="techie_join_section">
                <div class="techie_butns"> <a <?php if((in_array('employer', $user->roles)) || (in_array('administrator', $user->roles)) ){ ?> href="<?php echo site_url()."/profile/973";?>" <?php } else { ?> type="button" data-toggle="modal" data-target=".bs-example-modal-sm" <?php } ?> class="build-your-team">View my profile</a> <a onclick="hire_me(973)" type="button" data-toggle="modal" data-target=".bs-example-modal-sm" class="build-your-team">Hire me</a> </div>
              </div>
            </div>
          </div>
          <div class="serchtechie_width techie_width">
            <div class="tech-all-details"> <a  type="button" class="" data-toggle="modal" data-target=".bs-example-modal-sm" >
              <div class="featured_techei_img"> <img src="https://www.findmetechie.com/wp-content/uploads/thumbs/968/IMG_20160411_224745.jpg"> </div>
              <div class="featured_techei_title">
                <p class="featured-title">ASP.net,MVC Dev.</p>
                <span class="featured_techei_id"> <img src="https://www.findmetechie.com/wp-content/themes/findmetechie/images/flag/in.png" alt="" title="Pakistan" /> FMT ID: 968 </span> <span class="featured_techei_exp"> 4 Years </span> </div>
              <div class="featured_techei_added"> <span class="featured_techei_added_tech">Dotnet</span> </div>
              </a>
              <div class="techie_join_section">
                <div class="techie_butns"> <a <?php if((in_array('employer', $user->roles)) || (in_array('administrator', $user->roles)) ){ ?> href="<?php echo site_url()."/profile/968";?>" <?php } else { ?> type="button" data-toggle="modal" data-target=".bs-example-modal-sm" <?php } ?> class="build-your-team">View my profile</a> <a onclick="hire_me(968)" type="button" data-toggle="modal" data-target=".bs-example-modal-sm" class="build-your-team">Hire me</a> </div>
              </div>
            </div>
          </div>
          <div class="serchtechie_width techie_width">
            <div class="tech-all-details"> <a  type="button" class="" data-toggle="modal" data-target=".bs-example-modal-sm" >
              <div class="featured_techei_img"> <img src="https://www.findmetechie.com/wp-content/uploads/thumbs/757/Picture032.jpg" alt="techie"/> </div>
              <div class="featured_techei_title">
                <p class="featured-title">.net, Sitecore Developer</p>
          ...
          <div class="serchtechie_width techie_width">
            <div class="tech-all-details"> <a  type="button" class="" data-toggle="modal" data-target=".bs-example-modal-sm" >
              <div class="featured_techei_img"> <img src="https://www.findmetechie.com/wp-content/uploads/thumbs/846/IMG_20170811_221452.jpg" alt="techie"/> </div>
              <div class="featured_techei_title">
                <p class="featured-title">Dotnet Developer</p>
                <span class="featured_techei_id"> <img src="https://www.findmetechie.com/wp-content/themes/findmetechie/images/flag/in.png" alt="" title="India" /> FMT ID: 846 </span> <span class="featured_techei_exp"> 2 Years </span> </div>
              <div class="featured_techei_added"> <span class="featured_techei_added_tech">Dotnet</span> </div>
              </a>
              <div class="techie_join_section">
                <div class="techie_butns"> <a <?php if((in_array('employer', $user->roles)) || (in_array('administrator', $user->roles)) ){ ?> href="<?php echo site_url()."/profile/846";?>" <?php } else { ?> type="button" data-toggle="modal" data-target=".bs-example-modal-sm" <?php } ?> class="build-your-team">View my profile</a> <a onclick="hire_me(846)" type="button" data-toggle="modal" data-target=".bs-example-modal-sm" class="build-your-team">Hire me</a> </div>
              </div>
            </div>
          </div>
          <div class="serchtechie_width techie_width">
            <div class="tech-all-details"> <a  type="button" class="" data-toggle="modal" data-target=".bs-example-modal-sm" >
              <div class="featured_techei_img"> <img src="https://www.findmetechie.com/wp-content/uploads/thumbs/740/61cd2f36-ba12-4033-a78f-5b163da9a142.jpg"> </div>
              <div class="featured_techei_title">
                <p class="featured-title">Sr. Dotnet Developer</p>
                <span class="featured_techei_id"> <img src="https://www.findmetechie.com/wp-content/themes/findmetechie/images/flag/in.png" alt="" title="India" /> FMT ID: 740 </span> <span class="featured_techei_exp"> 5 Years </span> </div>
              <div class="featured_techei_added"> <span class="featured_techei_added_tech">Dotnet</span> </div>
              </a>
              <div class="techie_join_section">
                <div class="techie_butns"> <a <?php if((in_array('employer', $user->roles)) || (in_array('administrator', $user->roles)) ){ ?> href="<?php echo site_url()."/profile/740";?>" <?php } else { ?> type="button" data-toggle="modal" data-target=".bs-example-modal-sm" <?php } ?> class="build-your-team">View my profile</a> <a onclick="hire_me(740)" type="button" data-toggle="modal" data-target=".bs-example-modal-sm" class="build-your-team">Hire me</a> </div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="main-block">
        <div class="col-md-3 col-sm-6 col-xs-12 section_backcolor_ror">
          <div class="block_ror">
            ...
            <h3>Our DotNet Services</h3>
            <ul>
              <li>Web and Application Development</li>
              <li>Asp.Net MVC3/MVC4 Development</li>
              <li>Application Support and Maintenance</li>
              <li>.Net Migration from Legacy (VB, ASP) Applications</li>
  ...
  <div class="hire_perfect">
    <div class="do_more wow fadeInDown " data-wow-duration="1000ms" data-wow-delay="200ms">
      <div class="domore_content">
        ...
        <p> Expertise in creating robust ASP.NET web applications web sites with latestASP.NET 4.5 and ASP.NET MVC 4 , VB and C#.</p>
        <p>Our Project Managers have deep knowledge of continuous integration, Agile and DevOps methodologies.</p>
        <p>We have developed some best cross platform applications using .NET for small and large scale businesses.</p>
      </div>
    </div>
