...
?>/images/ios-banner.jpg) no-repeat center right;
...
<div class="banner-ror">
  <div class="container">
    <div class="ror-banner-caption">
      ...
      <h1>Looking to hire <span>IOS</span> developer?</h1>
        <ul>
...
<section id="scroll_down_ror" class="wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="200ms" >
  <div class="search-resumeRow1">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h3 class="techie-list remove-margin">Hire the best IOS freelancers</h3>
          ...
          <div id="techie_container">
            <div class="serchtechie_width techie_width">
              <div class="tech-all-details"> <a  type="button" class="" data-toggle="modal" data-target=".bs-example-modal-sm" >
                <div class="featured_techei_img"> <img src="https://www.findmetechie.com/wp-content/uploads/thumbs/753/download.png"> </div>
                <div class="featured_techei_title">
                  <p class="featured-title">Mobile Application Developer</p>
                  <span class="featured_techei_id"> <img src="https://www.findmetechie.com/wp-content/themes/findmetechie/images/flag/in.png" alt="" title="India" /> FMT ID: 753 </span> <span class="featured_techei_exp"> 10 Years </span> </div>
                <div class="featured_techei_added"> <span class="featured_techei_added_tech">IOS</span> </div>
                </a>
                <div class="techie_join_section">
                  <div class="techie_butns"> <a <?php if((in_array('employer', $user->roles)) || (in_array('administrator', $user->roles)) ){ ?> href="<?php echo site_url()."/profile/753";?>" <?php } else { ?> type="button" data-toggle="modal" data-target=".bs-example-modal-sm" <?php } ?> class="build-your-team">View my profile</a> <a onclick="hire_me(753)" type="button" data-toggle="modal" data-target=".bs-example-modal-sm" class="build-your-team">Hire me</a> </div>
                </div>
              </div>
            </div>
            <div class="serchtechie_width techie_width">
              <div class="tech-all-details"> <a  type="button" class="" data-toggle="modal" data-target=".bs-example-modal-sm" >
                <div class="featured_techei_img"> <img src="https://www.findmetechie.com/wp-content/uploads/thumbs/767/profilepic.jpg"> </div>
                <div class="featured_techei_title">
                  <p class="featured-title">Team Lead Mobile</p>
                  <span class="featured_techei_id"> <img src="https://www.findmetechie.com/wp-content/themes/findmetechie/images/flag/in.png" alt="" title="Pakistan" /> FMT ID: 767 </span> <span class="featured_techei_exp"> 10 Years </span> </div>
                <div class="featured_techei_added"> <span class="featured_techei_added_tech">IOS</span> </div>
                </a>
                <div class="techie_join_section">
                  <div class="techie_butns"> <a <?php if((in_array('employer', $user->roles)) || (in_array('administrator', $user->roles)) ){ ?> href="<?php echo site_url()."/profile/767";?>" <?php } else { ?> type="button" data-toggle="modal" data-target=".bs-example-modal-sm" <?php } ?> class="build-your-team">View my profile</a> <a onclick="hire_me(767)" type="button" data-toggle="modal" data-target=".bs-example-modal-sm" class="build-your-team">Hire me</a> </div>
                </div>
              </div>
            </div>
            <div class="serchtechie_width techie_width">
              <div class="tech-all-details"> <a  type="button" class="" data-toggle="modal" data-target=".bs-example-modal-sm" >
                <div class="featured_techei_img"> <img src="https://www.findmetechie.com/wp-content/uploads/thumbs/849/PASSPORT.png" alt="techie"/> </div>
                <div class="featured_techei_title">
                  <p class="featured-title">Web|Mobile|Script Developer</p>
                  <span class="featured_techei_id"> <img src="https://www.findmetechie.com/wp-content/themes/findmetechie/images/flag/in.png" alt="" title="India" /> FMT ID: 849 </span> <span class="featured_techei_exp"> 10 Years </span> </div>
                <div class="featured_techei_added"> <span class="featured_techei_added_tech">IOS</span> </div>
                </a>
                <div class="techie_join_section">
                  <div class="techie_butns"> <a <?php if((in_array('employer', $user->roles)) || (in_array('administrator', $user->roles)) ){ ?> href="<?php echo site_url()."/profile/849";?>" <?php } else { ?> type="button" data-toggle="modal" data-target=".bs-example-modal-sm" <?php } ?> class="build-your-team">View my profile</a> <a onclick="hire_me(849)" type="button" data-toggle="modal" data-target=".bs-example-modal-sm" class="build-your-team">Hire me</a> </div>
                </div>
              </div>
            </div>
            <div class="serchtechie_width techie_width">
              <div class="tech-all-details"> <a  type="button" class="" data-toggle="modal" data-target=".bs-example-modal-sm" >
                <div class="featured_techei_img"> <img src="https://www.findmetechie.com/wp-content/uploads/thumbs/1704/Screen Shot 2017-06-20 at 6.56.58 PM.png" alt="techie"/> </div>
                <div class="featured_techei_title">
                  <p class="featured-title">Sr. Mobile Application Developer</p>
                  <span class="featured_techei_id"> <img src="https://www.findmetechie.com/wp-content/themes/findmetechie/images/flag/in.png" alt="" title="India" /> FMT ID: 1704 </span> <span class="featured_techei_exp"> 5 Years </span> </div>
                <div class="featured_techei_added"> <span class="featured_techei_added_tech">IOS</span> </div>
                </a>
                <div class="techie_join_section">
                  <div class="techie_butns"> <a <?php if((in_array('employer', $user->roles)) || (in_array('administrator', $user->roles)) ){ ?> href="<?php echo site_url()."/profile/1704";?>" <?php } else { ?> type="button" data-toggle="modal" data-target=".bs-example-modal-sm" <?php } ?> class="build-your-team">View my profile</a> <a onclick="hire_me(1704)" type="button" data-toggle="modal" data-target=".bs-example-modal-sm" class="build-your-team">Hire me</a> </div>
                </div>
              </div>
            </div>
            <div class="serchtechie_width techie_width">
              <div class="tech-all-details"> <a  type="button" class="" data-toggle="modal" data-target=".bs-example-modal-sm" >
                <div class="featured_techei_img"> <img src="https://www.findmetechie.com/wp-content/uploads/thumbs/912/17353374_10154698358547600_1589160343414382824_n.jpg"> </div>
                <div class="featured_techei_title">
                  <p class="featured-title">Mobile Developer</p>
                  <span class="featured_techei_id"> <img src="https://www.findmetechie.com/wp-content/themes/findmetechie/images/flag/in.png" alt="" title="India" /> FMT ID: 912 </span> <span class="featured_techei_exp"> 2 Years </span> </div>
                <div class="featured_techei_added"> <span class="featured_techei_added_tech">IOS</span> </div>
                </a>
                <div class="techie_join_section">
                  <div class="techie_butns"> <a <?php if((in_array('employer', $user->roles)) || (in_array('administrator', $user->roles)) ){ ?> href="<?php echo site_url()."/profile/912";?>" <?php } else { ?> type="button" data-toggle="modal" data-target=".bs-example-modal-sm" <?php } ?> class="build-your-team">View my profile</a> <a onclick="hire_me(912)" type="button" data-toggle="modal" data-target=".bs-example-modal-sm" class="build-your-team">Hire me</a> </div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="main-block">
        <div class="col-md-3 col-sm-6 col-xs-12 section_backcolor_ror">
          <div class="block_ror">
            ...
            <h3>Our IOS Services</h3>
            <ul>
              <li>Native iOS App Development</li>
              <li>iPhone UX/UI Designing</li>
              <li>iPhone Ecommerce Apps</li>
              <li>iPhone Social Networking Apps</li>
              <li>iPhone Games Development</li>
              <li>iPhone Support , Maintenance and Optimization</li>
              <li>iPhone App Testing</li>
              <li>iPhone and iPad App Upgrade</li>
			  <li>iPad Custom App Development</li>
            </ul>
          </div>
        </div>
        <div class="col-md-3 col-sm-6 col-xs-12 section_backcolor_ror">
  ...
  <div class="hire_perfect">
    <div class="do_more wow fadeInDown " data-wow-duration="1000ms" data-wow-delay="200ms">
      <div class="domore_content">
        ...
        <p> Experience C and Objective-C developers</p>
        <p> Dedicated UI/UX experts</p>
        <p> Secure and scalable iPhone applications</p>
        <p> Coding as per Apple guidelines</p>
        <p> Guaranteed App Store Compliant</p>
      </div>
    </div>
    ...
    <div class="resume-container">
      <div class="row">
        <div class="col-md-2 col-sm-2 col-xs-6 resume-box">
          <div class="profileImage"> <a href="https://www.findmetechie.com/technology/android/"> <img src="https://www.findmetechie.com/wp-content/uploads/2017/07/android.png">
            <p class="title_service"> Android </p>
            </a> </div>
        </div>
        <div class="col-md-2 col-sm-2 col-xs-6 resume-box">
          <div class="profileImage"> <a href="https://www.findmetechie.com/technology/gaming/"> <img src="https://www.findmetechie.com/wp-content/uploads/2017/05/22.png">
            <p class="title_service"> Gaming </p>
            </a> </div>
        </div>
        <div class="col-md-2 col-sm-2 col-xs-6 resume-box">
          <div class="profileImage"> <a href="https://www.findmetechie.com/technology/mobility/"> <img src="https://www.findmetechie.com/wp-content/uploads/2017/02/11-1.png">
            <p class="title_service"> Mobility </p>
            </a> </div>
        </div>
        <div class="col-md-2 col-sm-2 col-xs-6 resume-box">
          <div class="profileImage"> <a href="https://www.findmetechie.com/technology/phonegap/"> <img src="https://www.findmetechie.com/wp-content/uploads/2017/07/phongap-1.png">
            <p class="title_service"> PhoneGap </p>
            </a> </div>
        </div>
        <div class="col-md-2 col-sm-2 col-xs-6 resume-box">
          <div class="profileImage"> <a href="https://www.findmetechie.com/technology/unity-3d/"> <img src="https://www.findmetechie.com/wp-content/uploads/2017/07/unity.png">
            <p class="title_service"> Unity 3D </p>
            </a> </div>
        </div>
        <div class="col-md-2 col-sm-2 col-xs-6 resume-box">
          <div class="profileImage"> <a href="https://www.findmetechie.com/technology/xamarin/"> <img src="https://www.findmetechie.com/wp-content/uploads/2017/07/xamarien.png">
            <p class="title_service"> Xamarin </p>
            </a> </div>
        </div>
      </div>
    </div>
